				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="{{URL::asset('assets/img/faces/avatar-5.png')}}">
							...
							$notifications = Notification::latest()->where('status', 0)->first();						    ?>
						...
						<div class="dropdown nav-item main-header-notification">
							<a class="new nav-link" href="#">
								...
								@if ($notifications && $notifications->status == 0)
							...
							<div class="dropdown-menu">
								...
								@if ($notifications)
									<div class="main-notification-list Notification-scroll" style="display: none;">
										<form action="{{ url("/update-notification-status/{$notifications->id}") }}" method="POST">
											@csrf
											@method('POST')
											<button type="submit" class="d-flex p-3 border-bottom" style="background: none; border: none; cursor: pointer;">
												<div class="notifyimg bg-success">
													<i class="la la-shopping-basket text-white"></i>
												</div>
												<div class="mr-3">
													<h5 class="notification-label mb-1">{{ $notifications->type }}</h5>
													<div class="notification-subtext">{{ $notifications->message }}</div>
												</div>
												<div class="mr-auto">
										...
										<form action="{{ url('/update-all-notifications-status') }}" method="POST">
											@csrf
											@method('POST')
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/avatar-5.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/avatar-5.png')}}" class=""></div>
...
<script>
    $(document).ready(function () {
        $('.new.nav-link').click(function () {
            $('.main-notification-list').toggle();
        });
    });
</script>
